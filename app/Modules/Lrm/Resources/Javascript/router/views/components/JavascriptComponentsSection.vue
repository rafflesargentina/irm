...
<script>
import { Modal } from "@irm/components"
export default {
    components: {
        Modal
    },
    data() {
        return {
            ...
            carousel1: require("@irm/assets/img/nature-2.jpg"),
            carousel2: require("@irm/assets/img/nature.jpg"),
            carousel3: require("@irm/assets/img/nature-3.jpg")
        }
    },
    methods: {
        classicModalHide() {
